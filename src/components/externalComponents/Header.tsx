...
const Header = ({ date, title }: Props) => {
	...
	return (
		<div className='w-full bg-white shadow-bottom-only font-inter py-4 px-4 sm:px-8 xl:px-[5rem]'>
			<div className='w-full'>
				<div className='w-full flex flex-col xs:flex-row justify-between xs:items-center'>
					...
					{/* notify/profile */}
					<div className='flex items-center justify-end xs:justify-normal sm:gap-4'>
						{/* notify */}
						<button>
							<div>
								<img className='w-5 h-6' src='/notify.png' alt='' />
							</div>
						</button>
						...
						<Menu open={openMenu} handler={setOpenMenu} allowHover>
							<MenuHandler>
								<Button
									...
									<p className='font-bold hidden md:block'>Oluwadara Eniola</p>
