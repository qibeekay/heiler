              ...
              <div className="relative w-fit">
                ...
                <div className="w-[10rem] aspect-square overflow-hidden rounded-full mx-auto relative ">
                  <img
                    ...
                    src={formData.photo || "/doctors.jpg"}
                    alt=""
                  />
                </div>
                ...
                {isLoading && (
                  <div className="w-full h-full absolute top-0 bg-black/60 rounded-full">
            ...
            <div className="flex flex-col gap-7 my-[3.5rem]">
              ...
              {usertype === "Doctor" && (
                <div className="flex items-center gap-4">
                  <input
                    ...
                    type="text"
                    name="title"
                    value={isLoading ? "loading.." : formData.title}
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  type="text"
                  name="firstName"
                  value={isLoading ? "loading..." : formData.firstName}
                  onChange={handleChange}
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  type="text"
                  name="lastName"
                  value={isLoading ? "loading..." : formData.lastName}
                  onChange={handleChange}
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  type="text"
                  name="phone"
                  value={isLoading ? "loading..." : formData.phone}
                  onChange={handleChange}
                  placeholder="Phone"
                />
